...
When you remove code, never remove the import first. That causes an error until you fix every reference. It makes it harder for you to tell when you made a real error
...
You should check diagnostics before giving up control to make sure you didn't make any mistakes